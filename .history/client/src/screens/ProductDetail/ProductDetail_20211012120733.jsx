  ...
  return (
    <Layout>
      <div className="flex justify-center items-center min-h-screen min-w-max">
        <div className=" bg-black grid grid-cols-2 grid-rows-4 p-10 m-10 ">
          <div className="col-start-1 text-2xl font-bold h-10">{product.name}</div>
          <div className="col-start-1 max-w-xs">{product.description}</div>
          <div className="col-start-1">
          <ul className="w-56">{product.details.map((detail) => {
                return <li> - {detail}</li>
              })}</ul>
          </div>
          <div className="col-start-1">
