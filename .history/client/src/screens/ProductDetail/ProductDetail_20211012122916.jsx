    ...
    <div class="flex max-w-xl mx-auto overflow-hidden bg-black rounded justify-center items-center">
        ...
        <div class="w-2/3 p-4 md:p-4">
            ...
            <div class="flex justify-between mt-3 item-center">
                ...
                <button class="px-2 py-1 text-xs font-bold text-white uppercase transition-colors duration-200 transform bg-gray-800 rounded dark:bg-gray-700 hover:bg-gray-700">Add to Cart</button>
            </div>
        </div>
