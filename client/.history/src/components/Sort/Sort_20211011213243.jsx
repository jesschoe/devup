...
const Sort = (props) => {
    ...
    return (
        <form className="block w-52 py-2 px-3 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500" onSubmit={props.handleSubmit}>
