...
const Sort = (props) => {
    ...
    return (
        <form className="block w-52 py-2 px-3 rounded-md text-orange" onSubmit={props.handleSubmit}>
            ...
            <select className="sort" onChange={handleSort}>
                ...
                <option className="border-purplevalue="price-low-high">Price, low to high</option>
