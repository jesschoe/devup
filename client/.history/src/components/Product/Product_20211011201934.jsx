...
const Product = (props) => {
    return (
      ...
      <h1 className="card-title text-white text-4xl font-hand">name</h1>
      <div>
      ...
      <button className="font-sans rounded-2xl bg-transparent text-2xl p-3 hover:-translate-y-.5 transform transition hover:bg-red-900">
        Add!</button>
    </div>
        </>
    )
